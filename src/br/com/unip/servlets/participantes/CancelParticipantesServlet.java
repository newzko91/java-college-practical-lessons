...
@WebServlet(urlPatterns = { "/cancelarparticipante" })

public class CancelParticipantesServlet extends HttpServlet {
	private static final long serialVersionUID = 3713505926838432833L;

	public CancelParticipantesServlet() {
		super();
	}
